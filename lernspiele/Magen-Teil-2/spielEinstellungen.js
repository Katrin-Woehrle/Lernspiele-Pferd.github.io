...
function nach_Spieleinstellungen_fragen()
{
    ...
    output_fenster.document.write ('<br><input type="button" name="button_SpielStarten" value="Starte das Lernspiel zu Thema 2: Magen Teil 2" onClick="top.starte_spiel();"><br>\n');
