...
function nach_Spieleinstellungen_fragen()
{
    ...
    output_fenster.document.write ('<br><input type="button" name="button_SpielStarten" value="Starte das Lernspiel zu Thema 4: Dickdarm Teil 1" onClick="top.starte_spiel();"><br>\n');
    ...
    output_fenster.document.write ('<br><input type="button" name="button_Zurueck" value="Zurück zur Startseite" onClick="http://lernspiele-pferd.github.io/"><br>\n');
